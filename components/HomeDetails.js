    ...
    <div>
      <Container>
        ...
        <ul>
          ...
          <li >Click on the &ldquo;Advanced Search&rdquo; icon to customize your search.</li>
        ...
        <ul>
          ...
          <li >Add the asked details, like trip type, travel destinations, dates, and more.</li>
          <li >Click on the &ldquo;Search&rdquo; icon to fetch the list of flights.</li>
        ...
        <ul>
          ...
          <li >Share your travel priorities with the assigned Copa Airlines representative.</li>
        ...
        <ul>
          <li ><strong>Unlimited Flight Deals</strong>: Copa Airlines offers various flight deals and discounts on flights to worldwide destinations.</li>
          <li ><strong>Extensive Flight Network</strong>: The airline operates flights to various domestic and international destinations, opening up a world of possibilities for your next adventure.</li>
          <li ><strong>24*7 Customer Service:</strong> The Copa Airlines representatives are reachable 24 hours a day through multiple channels.</li>
          <li ><strong>Great Amenities</strong>: Copa Airlines offers top-notch onboard amenities that will make your journey unforgettable.</li>
        ...
        <ul>
          <li >The unaccompanied minors can only fly on direct flights.&nbsp;</li>
          <li >For kids between 15 and 17 years, the unaccompanied minor service is optional.</li>
          <li >You must request the service at least 48 hours prior to the flight departure.&nbsp;</li>
          <li >Copa Airlines accepts 25 unaccompanied minors per flight.</li>
          <li >This service does not include any additional services on the flight.</li>
          <li >Please note that the unaccompanied minor service is non-refundable.</li>
          <li >The airline agent will accompany the child through the security, immigration process and to the boarding gate. They will make children sit in their seats on the flight.</li>
      ...
      <tbody>
        ...
        <ul>
          ...
          <li >Pets should be in a container that will replace your carry-on bag.</li>
          <li >Travelers with pets can&rsquo;t fly in Business Class.</li>
          <li >Make sure to check your pet at least 48 hours before the flight departure.&nbsp;</li>
          <li >Copa accepts only 3 pets in the main cabin.</li>
          <li >Only one person is allowed per passenger on the flight.</li>
          <li >You can&rsquo;t travel with pets on connecting flights with other airlines.</li>
      ...
      <tbody>
        ...
        <ul>
          ...
          <li >Select red-eye flights for better discounts on flight tickets.</li>
          <li >Budget-savvy travelers can use the Copa Airlines low fare calendar to find discounted fares.</li>
          <li >Off-peak hours are the best time to book tickets at low fares.</li>
          <li >You must subscribe to the airline&rsquo;s newsletter for timely updates on new deals and offers.</li>
        </ul>
