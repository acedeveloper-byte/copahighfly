    ...
    <>
      ...
      <div className="container home-text ">
        <div className="col-md-5">
          <h1>Book Your Next Trip For Less</h1>
          <p>
            Get exclusive deals on Copa flights, and fly off on a budget. At
            Copahighfly, we promise to connect you to your destination at
            discounted fares.
          </p>
        </div>
      </div>
      ...
      <div
        className="container p-4 bg-white rounded-4 shadow-sm search-form"
        ...
        <div className="d-flex justify-content-between mb-4 px-2">
          {["economy", "business", "first"].map((type) => (
            <button
              key={type}
              className={`btn ${
                flightClass === type ? "btn-primary" : "btn-light"
              } flex-fill mx-2`}
